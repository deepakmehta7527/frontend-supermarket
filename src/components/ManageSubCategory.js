        ...
        if (window.confirm("Are you sure to delete?")) {
          try {
            var resp = await fetch(
              `${process.env.REACT_APP_APIURL}/delsubcat/${id}`,
              {
                method: "delete",
              }
            );
            if (resp.ok) {
              ...
              if (result.statuscode === 1) {
                ...
                toast.success("Sub Category not deleted successfully");
             }
            ...
            <div className="login">
                <div className="container">
                    ...
                    <div className="login-form-grids animated wow slideInUp" data-wow-delay=".5s">
                        ...
                        {editmode?
                            <>
                                <img src={`uploads/${picname}`} alt="not found" height='75'/>Choose new image, if required<br/><br/>
                            </>:null
                        }
                    ...
                    <>
                        ...
                        <table className="timetable_sub">
                            <tbody>
                                ...
                                <tr key={index}>
                                    <td><img src={`uploads/${data.picture}`} alt="not found" height='75'/></td>
